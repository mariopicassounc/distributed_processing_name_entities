...
public class Article implements Serializable {
	...
	public String getTitleAndText() {
		...
		text = text.replaceAll("[^a-zA-Z' ]|'s\\b", "");
		return text;
	}
	...
	public static void main(String[] args) {
		Article a = new Article("This \"Historically\" Black University Created Its Own Tech Intern Pipeline",
				"A new program at Bowie State connects computing's students directly with companies, bypassing an often harsh Silicon Valley vetting process",
				new Date(),
				"https://www.nytimes.com/2023/04/05/technology/bowie-hbcu-tech-intern-pipeline.html");

		System.out.println(a.getTitleAndText());
	}
